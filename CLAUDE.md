...
- **Modular via `go.work`:** the heavy logic lives in **32 externalized `algo2go/kite-mcp-*` modules** (riskguard, paper, oauth, audit, alerts, app, ops, telegram, rotate, kc, ...); this deploy repo holds `cmd/` + `main.go` + glue and wires them together. ~9000 tests across 493 files.
