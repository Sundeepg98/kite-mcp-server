...
find . -name '*.go' -type f -exec sed -i 's#github.com/zerodha/kite-mcp-server/kc/ticker#github.com/algo2go/kite-mcp-ticker#g' {} \;
sed -i 's#^module github.com/zerodha/kite-mcp-server/kc/ticker$#module github.com/algo2go/kite-mcp-ticker#' go.mod
