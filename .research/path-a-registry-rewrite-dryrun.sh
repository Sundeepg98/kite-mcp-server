...
find . -name '*.go' -type f -exec sed -i 's#github.com/zerodha/kite-mcp-server/kc/registry#github.com/algo2go/kite-mcp-registry#g' {} \;
sed -i 's#^module github.com/zerodha/kite-mcp-server/kc/registry$#module github.com/algo2go/kite-mcp-registry#' go.mod

# Drop stale workspace artifacts (kc/registry has no actual root imports in source)
