...
find . -name '*.go' -type f -exec sed -i 's#github.com/zerodha/kite-mcp-server/kc/telegram#github.com/algo2go/kite-mcp-telegram#g' {} \;
sed -i 's#^module github.com/zerodha/kite-mcp-server/kc/telegram$#module github.com/algo2go/kite-mcp-telegram#' go.mod
