...
find . -name '*.go' -type f -exec sed -i 's#github.com/zerodha/kite-mcp-server/kc/riskguard#github.com/algo2go/kite-mcp-riskguard#g' {} \;
sed -i 's#^module github.com/zerodha/kite-mcp-server/kc/riskguard$#module github.com/algo2go/kite-mcp-riskguard#' go.mod
