...
find . -name '*.go' -type f -exec sed -i 's#github.com/zerodha/kite-mcp-server/kc/papertrading#github.com/algo2go/kite-mcp-papertrading#g' {} \;
sed -i 's#^module github.com/zerodha/kite-mcp-server/kc/papertrading$#module github.com/algo2go/kite-mcp-papertrading#' go.mod
