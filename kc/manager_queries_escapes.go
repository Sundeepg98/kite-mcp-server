...
func (m *Manager) registerEscapeQueries() {
	// --- Margin queries ---

	m.queryBus.Register(reflect.TypeOf(cqrs.GetOrderMarginsQuery{}), func(ctx context.Context, msg any) (any, error) {
	...
	m.queryBus.Register(reflect.TypeOf(cqrs.GetBasketMarginsQuery{}), func(ctx context.Context, msg any) (any, error) {
		q := msg.(cqrs.GetBasketMarginsQuery)
		uc := usecases.NewGetBasketMarginsUseCase(m.resolverFromContext(ctx), m.Logger)
		return uc.Execute(ctx, q)
	})

	m.queryBus.Register(reflect.TypeOf(cqrs.GetOrderChargesQuery{}), func(ctx context.Context, msg any) (any, error) {
